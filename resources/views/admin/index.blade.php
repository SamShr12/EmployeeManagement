...
<body>
  ...
  <ul id="slide-out" class="side-nav fixed z-depth-2">
    <li class="center no-padding">
      <div class="white-text" style="height: 180px; background-color: #323232;">
        <div class="row">
    ...
    <ul class="collapsible" data-collapsible="accordion">
      <li id="dash_users">
        ...
        <div id="dash_users_body" class="collapsible-body">
          <ul>
            <li id="users_seller">
              <a class="waves-effect" style="text-decoration: none;" href="/admin">Employee</a>
            </li>

            <li id="users_customer">
              <a class="waves-effect" style="text-decoration: none;" href="#!">Intern</a>
            </li>
          </ul>
        </div>
      </li>
  ...
  <header>
    ...
    <nav class="" role="navigation" style="background: #323232;">
    ...
    <nav>
      <div class="nav-wrapper" style="background: #656262;">
          ...
          <div class="row">
            <a href="/admin">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                <i class="black-text text-lighten-1 large material-icons">person</i>
                <span class="black-text text-lighten-1"><h5>Employee</h5></span>
              </div>
            </a>
            ...
            <a href="#!">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                <i class="black-text text-lighten-1 large material-icons">people</i>
                <span class="black-text text-lighten-1"><h5>Intern</h5></span>
              </div>
            </a>
          </div>
        </div>
      ...
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
            <a href="#!">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                <i class="black-text text-lighten-1 large material-icons">store</i>
                <span class="black-text text-lighten-1"><h5>Product</h5></span>
              </div>
            </a>
            ...
            <a href="#!">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                <i class="black-text text-lighten-1 large material-icons">assignment</i>
                <span class="black-text text-lighten-1"><h5>Orders</h5></span>
              </div>
            </a>
          </div>
        </div>
      ...
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
            <a href="#!">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                <i class="black-text text-lighten-1 large material-icons">local_offer</i>
                <span class="black-text text-lighten-1"><h5>Brand</h5></span>
              </div>
            </a>
            ...
            <!-- <a href="#!">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                <i class="black-text text-lighten-1 large material-icons">loyalty</i>
                <span class="black-text text-lighten-1"><h5>Sub Brand</h5></span>
              </div>
            </a> -->
          </div>
        </div>
      ...
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
            <a href="#!">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                <i class="black-text text-lighten-1 large material-icons">view_list</i>
                <span class="black-text text-lighten-1"><h5>Category</h5></span>
              </div>
            </a>
            <div class="col s1">&nbsp;</div>
            <div class="col s1">&nbsp;</div>
<!-- 
    ...
    <div class="fixed-action-btn click-to-toggle" style="bottom: 45px; right: 24px;">
      ...
      <ul>
        ...
        <li>
          <a class="btn-floating red"><i class="material-icons">note_add</i></a>
          <a href="" class="btn-floating fab-tip">Add information</a>
        </li>
